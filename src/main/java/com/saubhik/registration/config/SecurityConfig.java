...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * 
	 * @Value("${security.security-realm}") private String securityRealm;
	 * 
	 * @Bean
	 * 
	 ...
	 * converter.setSigningKey(signingKey); return converter; }
	 * 
	 ...
	 * another token service instance of the same name public DefaultTokenServices
	 * tokenServices() { DefaultTokenServices defaultTokenServices = new
	 * DefaultTokenServices(); defaultTokenServices.setTokenStore(tokenStore());
